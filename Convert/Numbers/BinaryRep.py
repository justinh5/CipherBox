from tkinter import Frame, Button, Label, Entry, Listbox, StringVar, N, E, S, W
from Convert.Numbers.Convert import convert_binary
import sys
...
class BinRep(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        title = Label(self, text="Binary Representation Converter")
        ...
        l = ['Decimal', 'Unsigned', 'Sign and Magnitude', "One's Complement", "Two's Complement"]
        for x in l:
    ...
    def update_outputs(self, *args):
        ...
        try:
            ...
            if args[0] == 0:
                self.right_value.set(convert_binary(temp_left, left_type, right_type))
            else:
                self.left_value.set(convert_binary(temp_right, right_type, left_type))
